...
![轮播器](http://img.blog.csdn.net/20161120192854396)
 - UIScrollView ![常见属性](http://img.blog.csdn.net/20161120193149179)
 - 当发现点击其它控件轮播器停止工作时不要忘了察看主线程的工作模式
 ![主线程](http://img.blog.csdn.net/20161120193339072) 

- 设置UIPageControl的背景图片只能通过KVC来设置 ![KVC](http://img.blog.csdn.net/20161120193253257)
